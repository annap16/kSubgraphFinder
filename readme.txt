...
Żeby uruchomić:
./benchmark.exe n1 n2 k test_count solver_path mode(d/a)

Lub z głównego katalogu projektu:
g++ src/timeTests/benchmark.cpp -o src/timeTests/benchmark.exe
Żeby uruchomić:
./src/timeTests/benchmark.exe n1 n2 k test_count solver_path mode(d/a)
